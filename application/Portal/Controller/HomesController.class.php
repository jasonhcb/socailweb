 ...
 * 首页
 */
class HomesController extends HomebaseController {
	...
	public function index() {
		...
		$fix = $this->homeserver->where($condition)->limit($pages*10,10)->select();
		$allc = $this->homeserver->where($condition)->select();
		$count = count($allc);
		$allpage = $count%10;
		// echo $allpage;
