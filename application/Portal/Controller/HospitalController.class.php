 ...
 * 首页
 */
class HospitalController extends HomebaseController {
	...
	public function index() {
		...
		$hospital = $this->hospital->where($condition)->limit($page*10,10)->select();
		$allc = $this->hospital->where($condition)->select();
		$count = count($allc);
		$allpage = $count%10;
		// echo $allpage;
