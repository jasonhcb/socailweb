...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Property/edit',array('id'=>$post['id']));?>" target="_self"><?php echo L('ADS_EDIT');?></a></li>
		</ul>
		<form action="<?php echo U('Property/ads_edits',array('id'=>$post['id']));?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
...
<!-- 						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" style="width:400px;" name="adv_name" id="title" required value="<?php echo ($post['adv_name']); ?>" placeholder="请输入标题"/>
...
<!-- 						<tr>
						...
						<tr>
							<th>排序</th>
							<td>
								<input type="text" style="width: 400px" name="sort" id="description"  placeholder="排序" value="<?php echo ($post['sort']); ?>">
							</td>
						</tr>
						<tr>
							<th>公告内容</th>
							<td>
								<script type="text/plain" id="content" name="adv_content"><?php echo ($post['adv_content']); ?></script>
							</td>
						</tr>
<!-- 						<tr>
							<th>机构相册</th>
