...
<html>
	<head>
		...
		<link href="/socailsys/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<center><h2 style="color: white;">社区服务管理系统</h2></center>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/socailsys/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
