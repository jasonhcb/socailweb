...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('homeserver/addhome',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('HOME_ADD');?></a></li>
		</ul>
		<form action="<?php echo U('homeserver/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
