...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Socail/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('SOCAIL_ADD');?></a></li>
		</ul>
		<form action="<?php echo U('Socail/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
...
<!-- 						<tr>
						...
						<tr>
							<th width="100">社区名称</th>
							<td>
								<input type="text" style="width:400px;" name="socail_name" id="title" required value="<?php echo ($post['adv_name']); ?>" placeholder="请输入标题"/>
