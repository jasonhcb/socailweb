...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Property/user_add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('USER_ADD');?></a></li>
		</ul>
		<form action="<?php echo U('Property/user_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
...
<!-- 						<tr>
						...
						<tr>
							<th>负责内容</th>
							<td>
								<script type="text/plain" id="content" name="adv_content"></script>
							</td>
						</tr>
<!-- 						<tr>
							<th>机构相册</th>
