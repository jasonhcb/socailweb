...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Property/user_edit',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('USER_EDIT');?></a></li>
		</ul>
		<form action="<?php echo U('Property/user_epost',array('id'=>$result['id']));?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span12">
...
<!-- 							<td>
						...
						<tr>
							<th><b>缩略图</b></th>
								<td>
									<div>
										<input type="hidden" name="hos_img" id="thumb" value="<?php echo ($result['user_img']); ?>">
										<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<?php if(empty($result['user_img'])): ?><img src="/socailsys/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand" />
										<?php else: ?>
											<img src="<?php echo sp_get_asset_upload_path($result['user_img']);?>" id="thumb_preview" width="135" style="cursor: hand; height: 113px;"/><?php endif; ?>
										</a>
						...
						<tr>
							<th width="100">物业人员</th>
							<td>
								<input type="text" style="width:400px;" name="adv_name" id="title" required value="<?php echo ($result['user_name']); ?>" placeholder="请输入标题"/>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>联系方式</th>
							<td><input type="text" name="hos_mobile" id="keywords" value="<?php echo ($result['user_mobile']); ?>" style="width: 400px" placeholder="请输入联系方式"></td>
						</tr>
<!-- 						<tr>
						<th>地区：</th>
						<td>
...
<!-- 						<tr>
						...
						<tr>
							<th>负责内容</th>
							<td>
								<script type="text/plain" id="content" name="adv_content"><?php echo ($result['user_content']); ?></script>
							</td>
						</tr>
<!-- 						<tr>
							<th>机构相册</th>
...
<!-- 				<div class="span3">
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('Property/index');?>">返回</a>
			</div>
		</form>
	</div>
