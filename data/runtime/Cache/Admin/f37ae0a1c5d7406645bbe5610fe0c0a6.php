...
<body>
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Property/index');?>">
<!-- 			分类： 
		...
		<form class="js-ajax-form" action="" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td><a href="<?php echo U('portal/article/index',array('id'=>$vo['id']));?>" target="_blank"> <span><?php echo ($vo["adv_name"]); ?></span></a></td>
...
<!-- 					<td>
					...
					<td>
						<a href="<?php echo U('Property/edit',array('term'=>empty($term['term_id'])?'':$term['term_id'],'id'=>$vo['id']));?>"><?php echo L('EDIT');?></a> | 
						<a href="<?php echo U('Property/delete',array('term'=>empty($term['term_id'])?'':$term['term_id'],'id'=>$vo['tid']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a></td>
