			...
			<div class="span9">
				<div class="tabs">
					...
					<div class="tab-content">
								...
								<tbody>
									<?php if(is_array($comments)): foreach($comments as $key=>$vo): ?><tr>
										...
										<td>
											...
											<!-- | <a class="js-ajax-dialog-btn" href="<?php echo U('user/favorite/delete_favorite',array('id'=>$vo['id']));?>" data-msg="您确定要取消收藏吗？" data-ok="" data-cacel="取消">取消收藏</a> -->
										</td>
						...
						<div class="pagination"><ul><?php echo ($pager); ?></ul></div>
					</div>
				</div>
			</div>
		</div>
