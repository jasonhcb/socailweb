...
<body>
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('AdminPage/recyclebin');?>">
			时间： 
			<input type="text" name="start_time" class="input length_2 js-date" value="<?php echo ($formget["start_time"]); ?>" style="width: 80px;" autocomplete="off">-
			<input autocomplete="off" type="text" class="input length_2 js-date" name="end_time" value="<?php echo ($formget["end_time"]); ?>" style="width: 80px;">
			关键字：
		...
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminPage/clean');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
