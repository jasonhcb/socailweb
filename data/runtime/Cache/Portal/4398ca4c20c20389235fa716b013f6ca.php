	...
	<div class="container tc-main">
		<div class="row">
			<div class="span4 offset4">
				<h2 class="text-center"><span style="color: red;"><?php echo $_GET['server_name']; ?></span>—预约</h2>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="email">
						<form class="form-horizontal js-ajax-form" action="<?php echo U('portal/apoint/add');?>" method="post">
							<input type="text" name="term_id" placeholder="预约人" class="span4" style="display: none;"  value="<?php echo $_GET['term_id'];?>">
							<input type="text" name="server_name" placeholder="预约人" class="span4" style="display: none;"  value="<?php echo $_GET['server_name'];?>">
							<input type="text" name="server_id" placeholder="预约人" class="span4" style="display: none;" value="<?php echo $_GET['server_id'];?>">
							<input type="text" name="from_table" placeholder="预约人" class="span4" style="display: none;" value="<?php echo $_GET['from_table'];?>">
							<!-- <input type="text" name="email" placeholder="预约人" class="span4" style="display: none;"> -->
							<div class="control-group">
								<input type="text" name="user_name" placeholder="预约人" class="span4">
							</div>
<!-- 
							<div class="control-group">
								<select name="socail_id" required placeholder="社区选择">
								<option value="">社区选择</option>
								<?php if(is_array($socail)): $i = 0; $__LIST__ = $socail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["socail_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div> -->
		
							<div class="control-group">
								<input type="text" name="apoint_time" placeholder="预约时间" class="js-datetime date">
							</div>
							<div class="control-group">
								<input type="text" name="apoint_content" placeholder="预约内容" class="span4">
							</div>
							<div class="control-group">
								<input type="text" name="user_mobile" placeholder="联系方式" class="span4">
							</div>
							...
							<div class="control-group">
								<button class="btn btn-primary js-ajax-submit span4" type="submit" data-wait="1500" style="margin-left: 0px;">预约</button>
							</div>
		
							<div class="control-group" style="text-align: center;">
								<p>
									<a href="<?php echo leuu('user/login/index');?>">点击此处登录</a>
								</p>
							</div>
						</form>
