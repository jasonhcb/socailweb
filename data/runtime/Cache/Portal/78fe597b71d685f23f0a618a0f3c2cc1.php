...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('AdminPage/add');?>"><?php echo L('PORTAL_ADMINPAGE_ADD');?></a></li>
		</ul>
		<form action="<?php echo U('AdminPage/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			...
			<div class="row-fluid">
				...
				<div class="span3">
					<table class="table table-bordered">
						...
						<tr>
							<td><input type="text" name="post[post_modified]" value="<?php echo date('Y-m-d H:i:s',time());?>" class="js-datetime"></td>
						</tr>
						<tr>
							<th>状态</th>
						</tr>
