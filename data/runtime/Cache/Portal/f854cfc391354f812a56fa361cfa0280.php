...
<div class="callout callout-info" style="margin-top: 5px;margin-bottom: 0px;background-color: #428BCA !important;">
            ...
            <p>
            	<?php if(is_array($socail)): $i = 0; $__LIST__ = array_slice($socail,0,14,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('portal/homes/index',array('id'=>$vo[id]));?>" style="text-decoration:none;margin-left: 20px;"><span value="<?php echo ($vo["socail_name"]); ?>"><?php echo ($vo["socail_name"]); ?></span></a><?php endforeach; endif; else: echo "" ;endif; ?>
				<a href="<?php echo U('portal/homes/index',array('id'=>"all"));?>" style="text-decoration:none;margin-left: 20px;"><span value="">更多...</span></a>
            </p>
</div>
	...
	<div class="row">
		<div class="span9">
		    <div class="box box-default">
                ...
                <tr>
                <td>
                <a href="<?php echo U('portal/homes/index',array('id'=>$_GET[id]));?>"><button class="btn btn-block btn-primary" style="margin-top: 0px;">所有</button></a>
                </td>
            	...
            	<a href="<?php echo U('portal/homes/index',array('term_id'=>$vo['term_id'],'id'=>$_GET[id]));?>"><button class="btn btn-block btn-primary" style="margin-top: 0px;"><?php echo ($vo["name"]); ?></button></a>
            	<?php if(($mod) == "10"): ?></tr><tr><?php endif; ?>
            	</td>
              ...
              <?php if(is_array($fix)): $i = 0; $__LIST__ = $fix;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="attachment-block clearfix">
                    <img class="attachment-img" src="<?php echo sp_get_asset_upload_path($vo['home_img']);?>" alt="none" style="height: 100px;">
                    <div class="attachment-pushed">
                      <h3 class="attachment-heading" style="color: #070A0C;"><?php echo ($vo["home_name"]); ?><span style="color: #428bca;float: right;font-weight:bold;"><?php echo ($vo["home_mobile"]); ?></span></h3>
                      <h4 class="attachment-heading"><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["area"]); echo ($vo["stress"]); echo ($vo["home_address"]); ?></h4>
                      <a href="<?php echo U('portal/apoint/index',array('term_id'=>$vo['term_id'],'id'=>$_GET[id],'server_id'=>$vo[id],'server_name'=>$vo[home_name],'from_table'=>"homeserver"));?>"><button class="btn btn-block btn-info" style="float: right;width: 100px;">预约</button>
                      </a>                      <div class="attachment-text" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo ($vo["home_description"]); ?></div>
                    </div>
              </div><?php endforeach; endif; else: echo "" ;endif; ?>
              <div class="pagination">
  				<ul>
  				
    			<li><a href="<?php echo U('portal/homes/index',array('term_id'=>$_GET['term_id'],'id'=>$_GET[id],'page'=>$_GET[page]-1));?>">Prev</a></li>
    			<?php $__FOR_START_176355295__=0;$__FOR_END_176355295__=$allpage;for($i=$__FOR_START_176355295__;$i < $__FOR_END_176355295__;$i+=1){ ?><li><a href="<?php echo U('portal/homes/index',array('term_id'=>$_GET['term_id'],'id'=>$_GET[id],'page'=>$i+1));?>"><?php echo ($i+1); ?></a></li><?php } ?>
    			<li><a href="<?php echo U('portal/homes/index',array('term_id'=>$_GET['term_id'],'id'=>$_GET[id],'page'=>$_GET[page]+1));?>">Next</a></li>
  				</ul>
			  </div>
              </div>
